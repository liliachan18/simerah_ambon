        ...
        <div class="simkah-container">
            ...
            <div class="card-box">
                <div class="card text-bg-light mb-3" style="max-width: 18rem;">
                    <div class="card-header">Apa itu nikah?</div>
                    <div class="card-body">
                        <p class="card-text">Di dalam Islam, pernikahan itu bukan hanya berbicara tentang hubungan pria dan wanita yang diakui secara sah secara agama dan hukum negara, dan bukan hanya berbicara kebutuhan biologis laki-laki dan perempuan saja, tetapi pernikahan dalam Islam sangat erat kaitannya dengan kondisi jiwa manusia, kerohanian (lahir dan batin), nilai-nilai kemanusian, dan adanya suatu kebenaran.</p>
                    </div>
                </div>

                <div class="card text-bg-light mb-3" style="max-width: 18rem;">
                    <div class="card-header">Hadist nikah?</div>
                    <div class="card-body">
                        <h5 class="card-title">«يَا مَعْشَرَ الشَّبَابِ مَنِ اسْتَطَاعَ مِنْكُمُ الْبَاءَةَ فَلْيَتَزَوَّجْ وَمَنْ لَمْ يَسْتَطِعْ فَعَلَيْهِ بِالصَّوْمِ فَإِنَّهُ لَهُ وِجَاءٌ»</h5>
                        <p class="card-text">Artinya: Rasulullah SAW bersabda, "Wahai para pemuda, siapa di antara kalian yang telah mampu, maka hendaklah ia menikah, dan siapa yang belum mampu, maka hendaklah ia berpuasa, karena sesungguhnya puasa itu menjadi benteng baginya.”</p>
                    </div>
                </div>

                <div class="card text-bg-light mb-3" style="max-width: 18rem;">
                    <div class="card-header">Tentang Simkah</div>
                    <div class="card-body">
                        <p class="card-text">Simkah adalah platform modern yang membantu Anda mengurus segala administrasi pernikahan dengan mudah. Temukan kemudahan dan kenyamanan dalam proses pernikahan Anda bersama simerah_ambon Honipopu.</p>
                    </div>
                </div>
